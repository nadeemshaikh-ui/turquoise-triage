        ...
        {filtered.map((item) => {
          ...
          return (
            <button
              ...
              className="flex items-start gap-3 rounded-[28px] border border-border bg-card p-4 text-left shadow-[0_2px_12px_-4px_hsl(16_100%_50%/0.10)] transition-all hover:border-primary/30 hover:shadow-[0_4px_20px_-4px_hsl(16_100%_50%/0.18)]"
            >
